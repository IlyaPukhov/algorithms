fun main() {
    println(
        "Добро пожаловать в Калькулятор \"Infix to postfix\"!\n" +
    ...
    val stringExpr: String = readlnOrNull().toString()

    print(
        "Что вы хотите сделать с данным выражением?\n" +
    ...
    val mode: String = readlnOrNull().toString()
    when (mode.toInt()) {
        1 ->
        ...
        3 ->
            ...
            throw Exception("Ошибка! Попробуйте ещё раз.")
    }
}
